...
exports.IataValidatorClient = void 0;





class IataValidatorClient {
  constructor(config = {}) {
    ...
    this.baseUrl = config.baseUrl || 'https://api.stanzaapi.com/iata-validator';
    this.validateEndpoint = '/api/v1/validate';
    this.parseEndpoint = '/api/v1/validate';
    this.toolUrl = 'https://stanzaapi.com/tools/iata-validator';
  }
...
exports.IataValidatorClient = IataValidatorClient;
exports.default = IataValidatorClient;
